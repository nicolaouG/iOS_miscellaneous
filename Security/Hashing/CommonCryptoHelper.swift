...
//  TestProject
//
//  Created by george on 12/11/2020.
...
public extension String {
    ...
    /// # Sample code:
    /// ```
    /// let md5 = someString.hashed(.md5) // c2a9ce57e8df081b4baad80d81868bbb
    /// let sha1 = someString.hashed(.sha1) // 37fb219bf98bee51d2fdc3ba6d866c97f06c8223
    /// let sha256 = someString.hashed(.sha256) // 9da6c02379110815278b615f015f0b254fd3d5a691c9d8abf8141655982c046b
    /// ```
...
public extension Data {
    ...
    /// # Sample code:
    /// ```
    /// let md5 = someData.hashed(.md5) // c2a9ce57e8df081b4baad80d81868bbb
    /// let sha1 = someData.hashed(.sha1) // 37fb219bf98bee51d2fdc3ba6d866c97f06c8223
    /// let sha256 = someData.hashed(.sha256) // 9da6c02379110815278b615f015f0b254fd3d5a691c9d8abf8141655982c046b
    /// ```
    func hashed(_ type: HashType, output: HashOutputType = .hex) -> String? {
